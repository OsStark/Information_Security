...
while True:
    ...
    if message:
        ...
        n = len(message)
        for i in range(n%16, 16):
            message = message + "0"

        #print("Padding set to: " + str(config.padding))
        ...
        message_header = f"{len(toSend):<{HEADER_LENGTH}}".encode('utf-8')
        client_socket.send(message_header + toSend)
